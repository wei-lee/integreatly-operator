...
create_new_csv() {
  operator-sdk generate csv --operator-name "integreatly-operator" --csv-version "$VERSION" --default-channel --csv-channel=rhmi --update-crds --from-version "$PREVIOUS_VERSION"
}
